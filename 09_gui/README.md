...
Exercises to learn graphical user interface (GUI) programming in C on Linux.

## Exercises

- **1. Window:** Creating a simple window.
- **2. Button:** Adding a button and handling clicks.
...
- **10. Calculator GUI:** A simple GUI calculator app.
